<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;">
      ...
      />
      <el-button type="danger" size="mini" icon="el-icon-delete" v-auth="'sys:dept:delete'" @click="handleDelete()">删AA除</el-button>

      <el-button type="danger" size="mini" icon="el-icon-delete" v-auth="'sys:dept:test'" @click="handleDelete()">删AB除</el-button>
    </div>
    <!--表格树内容栏-->
